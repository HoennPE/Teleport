...
class HubTask extends Task
{
    ...
    public function onRun(int $currentTick)
    {
        ...
        if ($player instanceof Player) {
            ...
            $this->timer--;
            $player->addTitle(C::YELLOW . "Going back to Hub...");
            ...
            if ($this->timer <= 0) {
                ...
                $this->main->getScheduler()->cancelTask($this->getTaskId());
                $player->addTitle(C::BOLD . C::YELLOW . "Welcome to ", C::RED . "PMnS " . C::YELLOW . "Hub!");
                $player->sendTip(C::WHITE . "Vote this server at bit.ly/pmnserver");
			}
		}
        else {
            $this->main->getScheduler()->cancelTask($this->getTaskId());
